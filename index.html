...
<body class="bg-light text-dark">
  ...
  <main class="container my-5">
    <section id="about" class="mb-5">
      <h2>About Me</h2>
      <p>I am a detail-oriented automation tester with hands-on experience in Selenium, Cypress, and Playwright. I love breaking software to make it better!</p>
    </section>
    ...
    <section id="projects" class="mb-5">
      ...
      <div class="card mb-3">
        <div class="card-body">
          ...
          <p class="card-text">Automated the full shopping workflow using Selenium and TestNG — from login to checkout.</p>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text">Built a Cypress suite integrated with GitHub Actions for automated pull request testing and reporting.</p>
          <a href="#" class="btn btn-primary">View on GitHub</a>
        </div>
      </div>
    </section>
